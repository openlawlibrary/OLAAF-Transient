    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('edition', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='olaaf_django.Edition')),
            ],
        ),
        migrations.CreateModel(
            name='Hash',
        ...
        migrations.AddField(
            model_name='edition',
            name='repository',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='olaaf_django.Repository'),
        ),
        migrations.AddField(
            model_name='commit',
            name='edition',
        ...
        migrations.AddIndex(
            model_name='path',
            index=models.Index(fields=['filesystem', 'edition'], name='olaaf_djang_filesys_22bac8_idx'),
        ),
        migrations.AddIndex(
            model_name='path',
            index=models.Index(fields=['url', 'edition'], name='olaaf_djang_url_642439_idx'),
        ),
