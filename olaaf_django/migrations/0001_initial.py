# Generated by Django 2.2.5 on 2019-09-12 14:45
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', olaaf_django.models.LowerCharField(max_length=60)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url', olaaf_django.models.LowerCharField(max_length=260)),
                ('search_path', olaaf_django.models.LowerCharField(max_length=200, null=True)),
                ('citation', olaaf_django.models.LowerCharField(max_length=100, null=True)),
